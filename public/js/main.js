...
// const customImages = document.querySelectorAll('.custom-carousel-image');
// let customCurrentIndex = 1; // Start from the actual first image
// if (customImages.length === 0) {
//     console.error("No images found in 'customImages'");
//   }

// // Duplicate first and last images
// const firstImage = customImages[0].cloneNode(true);
// const lastImage = customImages[customImages.length - 1].cloneNode(true);



// // Append duplicates to the carousel
// carouselContainer.appendChild(firstImage); // Add duplicate of the first image to the end
// carouselContainer.insertBefore(lastImage, customImages[0]); // Add duplicate of the last image to the beginning

// // Adjust carousel width
// const totalImages = document.querySelectorAll('.custom-carousel-image'); // Update after adding duplicates

// function initializeCarousel() {
//   const width = totalImages[0].clientWidth + 40; // Include margin
//   carouselContainer.style.transition = 'none'; // Disable transition for initial positioning
//   carouselContainer.style.transform = `translateX(${-customCurrentIndex * width}px)`;
// }
...
//   // Reset transition after wrapping around
//   setTimeout(() => {
//     if (customCurrentIndex === 0) {
//       carouselContainer.style.transition = 'none';
//       customCurrentIndex = totalImages.length - 2; // Wrap to last actual image
//       carouselContainer.style.transform = `translateX(${
//         -customCurrentIndex * width
//       }px)`;
//     } else if (customCurrentIndex === totalImages.length - 1) {
//       carouselContainer.style.transition = 'none';
//       customCurrentIndex = 1; // Wrap to first actual image
//       carouselContainer.style.transform = `translateX(${
//         -customCurrentIndex * width
//       }px)`;
//     }
...
// // Initialize carousel on load and adjust on resize
// window.addEventListener('load', initializeCarousel);
// window.addEventListener('resize', initializeCarousel);

// // Fullscreen modal functionality (optional)
// function openCustomImage(image) {
...
// function closeCustomImage() {
//   const modal = document.getElementById('custom-image-modal');
//   modal.style.display = 'none';
// }

// // Close modal when clicking outside the image
// document.getElementById('custom-image-modal')?.addEventListener('click', closeCustomImage);